...
namespace path_searching
{
  ...
  void KinoAstar::init(ros::NodeHandle& nh)
  {
      ...
      nh_.param("search/horizon", horizon_, 50.0);
        ...
        nh_.param("search/step_arc", step_arc, 0.25);
      ...
      nh_.param("search/max_vel", max_vel_, 0.25);
      nh_.param("search/max_acc", max_acc_, 0.15);
  ...
  //This function is used to get the truncated path list
  ...
  bool KinoAstar::searchTime(plan_utils::KinoTrajData &flat_trajs, double &start_world_time)
  {
      ...
      while(!openSet_.empty())
      {
          ...
          if(one_shot_success)
          {
              ...
              reverse(middle_nodes_.begin(), middle_nodes_.end()); 
